...
print('Hello, welcome to photo organzier, answer the', end='')
print('questions to recieve the deminsions,', end='')
print('Enter the word done when you are done with the program')
